...
class InteractionProcess:
    ...
    def load_knowledge_base(self):
        kb_path = os.path.join(SCRIPT_DIR, "hospital_knowledge_base.json") # Optimized KB v4.1.1
    ...
    def _background_callback(self, recognizer, audio):
        ...
        try:
            with concurrent.futures.ThreadPoolExecutor() as executor:
                ...
                for future in concurrent.futures.as_completed(futures):
                    ...
                    try:
                        ...
                        logger.debug(f"Recognition error for {lang}: {e}")
            ...
            logger.error(f"Background callback error: {e}", exc_info=True)
