...
import json
import time
from src.interaction_process import InteractionProcess

def run_comprehensive_tests():
    # Load test data
    script_dir = os.path.dirname(os.path.abspath(__file__))
    data_path = os.path.join(script_dir, '..', 'data', 'comprehensive_test_data.json')
    ...
    import src.interaction_process as interaction_process
